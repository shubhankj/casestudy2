...
namespace StaticCodeAnalysisWebService
{
    ...
    {
        public string AnalyseCodeUsingPMDTool(string threshold, string batFilePath, string sampleCodeDirectory, string finalReportPath)
        {
            PMDToolService pMDToolService = new PMDToolService();
            bool status = pMDToolService.RunPMDTool(@"C:\Users\320052125\casestudy2\Analyser\pmd-bin-6.16.0\bin\pmd.bat", "addd", "hgshd");
            return "DONE " + status;
        }
